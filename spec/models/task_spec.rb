...
RSpec.describe Task, type: :model do
  ...
  describe '#task_record_save' do
    ...
    it 'days_a_weekが適切にリセットされるか' do
      task1 = @user.tasks.create(name: 'task1', created_at: 7.days.ago, days_a_week: 4, last_time: 1.days.ago)
      task2 = @user.tasks.create(name: 'task2', created_at: 8.days.ago, days_a_week: 4, last_time: 2.days.ago)
